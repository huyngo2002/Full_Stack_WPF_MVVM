        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountMolderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Users_AccountMolderId",
                        column: x => x.AccountMolderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_AccountMolderId",
                table: "Accounts",
                column: "AccountMolderId");
